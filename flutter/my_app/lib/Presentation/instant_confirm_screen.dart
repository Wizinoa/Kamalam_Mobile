...
class _ConfirmPurchaseScreenState
    extends State<ConfirmPurchaseScreen> {
  ...
  String get _screenTitle => _isSilver
      ? "Confirm Silver Purchase"
      : "Confirm Gold Purchase";

  String get _metalImage => _isSilver
      ? "assets/images/img10.png"
      : "assets/images/img11.png";

  Color get _cardBgColor => _isSilver
      ? const Color(0xFFF2F2F2)
      : const Color(0xFFFFF8EC);

  Color get _cardBorderColor => _isSilver
      ? const Color(0xFFD6D6D6)
      : const Color(0xFFFFE3A3);

  Color get _iconBgColor => _isSilver
      ? const Color(0xFFE0E0E0)
      : const Color(0xFFFFEAB7);

  String get _weightLabel =>
      _isSilver ? "Silver weight" : "Gold weight";

  String get _valueLabel =>
      _isSilver ? "Silver value" : "Gold value";

  String get _summaryWeightText =>
      "${widget.weight.toStringAsFixed(3)} g ${_isSilver ? 'Silver' : 'Gold'}";

  String get _purityText => _isSilver
      ? "999 Pure Digital Silver"
      : "22KT Pure Digital Gold";

  Color get _purityTextColor => _isSilver
  ...
  Future<void> _openRazorpayCheckout() async {
    ...
    try {
      ...
      final response =
          await paymentProvider.instantPayment(
        assetType: widget.metalType.toLowerCase(),
        grams: widget.weight.toString(),
        paymentMethod: "upi",
      );
