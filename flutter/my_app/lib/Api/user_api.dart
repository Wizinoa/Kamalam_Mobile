...
class UserApi {
  ...
  static Future<UserModel> updateProfile({
    ...
    File? aadharBack,
    File? panImage,
    String? panNumber,     // ← added
    String? aadharNumber,  // ← added
  }) async {
    final token = await LocalStorage.getToken();
    if (token == null) {
    ...
    try {
      ...
      if (panNumber != null) {
        request.fields['panNumber'] = panNumber;       // ← added
      }
      if (aadharNumber != null) {
        request.fields['aadharNumber'] = aadharNumber; // ← added
      }
      ...
      if (aadharFront != null) await addFile(aadharFront, 'aadharfrontImage');
      if (aadharBack != null) await addFile(aadharBack, 'aadharbackImage');
      if (panImage != null) await addFile(panImage, 'panImage');
